...
1021  format (4x,'3 - properties along the 1d computational path')
...
c----------------------------------------------------------------------
      ...
      logical node, change, readyn, lop48
...
30             write (*,1060) vnm(1),vmn(1),vmx(1)
               ...
               if (vmn(1).lt.vmx(1)) then 
                  ...
                  if (xmn.lt.vmn(1).or.xmn.gt.vmx(1)) then
                  ...
                  if (xmx.lt.vmx(1).and.xmx.gt.vmn(1)) then
                     write (*,1010) vnm(1),vmn(1),vmx(1)
                     ok = .false.
                  end if 
...
c                                 name and open plot file, write header
      ...
      call tabhed (n5,vr,dvr,k,1,n5name,n6name)
      ...
      call finprp (1,n5name,n6name,node)
