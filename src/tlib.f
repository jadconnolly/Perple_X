...
c----------------------------------------------------------------------
      ...
      write (n,'(/,a,//,a)') 
     *     'Perple_X release 7.1.17 December 22, 2025.',
      ...
      if (key.eq.'begin_special_componen') then
         ...
         do 
            ...
            if (.not.ok) then
               ...
               call errdbg ('the thermodynamic data file special '//
     *                      'component name '//cmpnt(1)//' does no'//
     *                      't match any of the data file components.')
            end if
