...
c-----------------------------------------------------------------------
      ...
      integer i, ii, n, icount, ifault, jcount, nfree, lu, nblen,
     *        j, k, igood, ibest, jbest, pnum(l2+k5), ipert

      logical readyn, bad, randm, n6out, improv, init, uncert, junk
