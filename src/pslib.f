...
c -------------------
     ...
     *'   /dp 1 def /dy dp 1.25 mul def %text offset rel. to box',
     *'   /lcr exch def',
     *'   /ry exch def',
     *'   /rx exch def',
     *'   /txt exch def',
     ...
     *'   0.2 lx mul 10 min /dx exch def%x offset',
     ...
     *'   rx dp add ry dy sub translate txt',
     *'      pp (++) eq {0 0} if',
     *'      pp (-+) eq {1 0} if',
     *'      pp (--) eq {1 1} if',
     *'      pp (+-) eq {0 1} if',
...
c     call psoclr
     ...
     *      xscale,yscale
         print *,'         (or perhaps x & y coordinates swapped?)'
      end if
